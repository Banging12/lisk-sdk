...
export const EMPTY_PLACEHOLDER_PREFIX = Buffer.from('02', 'hex');
export const LEAF_HASH_PREFIX_INT = 0;
export const BRANCH_HASH_PREFIX_INT = 1;
export const EMPTY_PLACEHOLDER_PREFIX_INT = 2;

export const NODE_HASH_SIZE = 32;
export const DEFAULT_KEY_LENGTH = 32; // (moduleID (4) + prefix (2) + key (32))
